...
get.nyt.hits(query.string="Data Science",     # OPTION
             begin.date="20160321",    # OPTION
             end.date  ="20170321")    # OPTION

article.df = get.nyt.articles(pages = -1,                 # all articles
                              query.string = "Data Science",     # OPTION
                              begin.date   = "20160321",  # OPTION
                              end.date     = "20170321")  # OPTION
dim(article.df)

###### article.df is adataframe contains headline, snippet, lead_paragraph, pub_date and abstract

# Check number of articles returned
num.articles = nrow(article.df)
num.articles
###### 1096 articles in total

# Check a random sample of 5 articles 
doc.ndx = sample(1:num.articles,5)
article.df[doc.ndx,]
article.df[doc.ndx,]$lead_paragraph
...
save(docs.clean, 
     file="C:/Users/Chengdong Liang/Desktop/MA 710/Assignment 3/docs.clean.RData")
load(file="C:/Users/Chengdong Liang/Desktop/MA 710/Assignment 3/docs.clean.RData")
...
docs.sns = 
  modify.words(
    ...
    stop.words=       # OPTION: stop words
      c(stopwords(kind="SMART"), stopwords(kind="english")
